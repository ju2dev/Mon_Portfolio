  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        il est porté à la connaissance des utilisateurs et visiteurs, 
        ci-après l’«Utilisateur», du site Mon Portfolio, ci-après le «Site», 
        ...
        <p>
        L’édition et la direction de la publication du Site sont assurées par Justine Piergiovanni, adresse e-mail : j.piergiovanni@icloud.com. Ci-après l’« Editeur ».
        </p>
        <p>
          <strong>ARTICLE 2 - L'HEBERGEUR</strong>
        </p>
        <p>
        L’hébergeur du Site est la société GitHub, Inc., dont le siège social est situé au 88 Colin P. Kelly Jr. Street, San Francisco, CA 94107, USA, fournissant un service d’hébergement via GitHub Pages.
        </p>
        <p>
        ...
        <p>
        En vertu de la loi Informatique et Libertés, l’Utilisateur dispose d’un droit d’accès, de rectification, de suppression et d’opposition de ses données personnelles. L’Utilisateur exerce ce droit par mail à l’adresse email j.piergiovanni@icloud.com.
        </p>
        <p>
          Le Site utilise Formspree.io pour la gestion des formulaires de contact. Les données collectées par ce biais (nom, adresse email, message) sont envoyées à Formspree. Pour plus d’informations sur la manière dont Formspree traite vos données, consultez leur politique de confidentialité : https://formspree.io/privacy.
        </p>
        <p>
